...
package zlfinch.util.time

//import com.github.benhutchison.mouse.all._
import mouse.all._
import com.twitter.util.Try
import zlfinch.util.time.TaggedTypesFunctions.{Millis, Seconds}
import zlfinch.util.time.Time.iso8601Formatter
...
object Time {
  ...
  private[zlfinch] val iso8601Parser = ISODateTimeFormat.dateTimeParser.withOffsetParsed()
